"""Generate robot_anymal_d recipe with downloaded USD path."""
...
def main() -> None:
    asset_dir = Path(newton.utils.download_asset("anybotics_anymal_d"))
    usd_path = str(asset_dir / "usd" / "anymal_d.usda")
