# robot_g1 — 2 Unitree G1 humanoids from remote USD asset.
...
"=== robot_g1 via newton-cli ===" | Tee-Object -FilePath $logFile

"--- prep (may download Unitree G1 asset) ---" | Tee-Object -FilePath $logFile -Append
...
& $py $viz $stateOut $snapshot $summary --title "robot_g1 (CLI)" 2>&1 |
    Tee-Object -FilePath $logFile -Append
